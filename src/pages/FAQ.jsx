...
const faqItems = [
    ...
    { category: 'kalite', question: 'NDT (Tahribatsız Muayene) nedir?', answer: 'NDT, malzeme veya bileşenlerin bütünlüğünü bozmadan kusur ve hataları tespit etmek için kullanılan test yöntemleridir. Sunduğumuz yöntemler: VT (Görsel Muayene), MT (Manyetik Parçacık Testi), PT (Sıvı Penetrant Testi), UT (Ultrasonik Test), RT (Radyografik Test), ET (Girdap Akımı Testi), TOFD ve Phased Array.' },
