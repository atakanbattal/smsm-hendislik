...
const reviews = [
    ...
    { name: 'Elif Demir', role: 'Kalite Direktörü, Rönesans', rating: 4.5, text: 'Kalite kontrol süreçlerinde gösterdikleri titizlik inanılmaz. Standartların ötesinde bir hizmet anlayışları var. Endüstriyel tesisimizin denetimlerinde hiçbir detayı atlamadılar.', image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuCPvQlkSfphkQKiI35JkU7gJvTfKuGDnYavNtH4SB7wZBJ4A3cwl9oG0M6sSSQ_PeSe0V91_cyYII0tXSq7SlJdC92tS9boq4BbVSZ_e2F4FsVrV9RjKNMbuyL9_RCTfaqZvOyyQBDyuYePYUxuwMFT_tL-KAQkO95dDW1dPBfuer46biwbd6pkPVNlxX8YuoaMg3h5ylpLv_NFeJg-R-x8OLFmYIr0A77Rtg8UaKzUoVSQChKBnaORi73B1Q1azaxARtgKD_yrayt_' },
    ...
    { name: 'Canan Yıldız', role: 'Operasyon Müdürü, Limak', rating: 5, text: 'Danışmanlık hizmetleri kapsamında aldığımız destek, maliyetlerimizi %15 oranında düşürmemizi sağladı. Sadece mühendislik değil, maliyet yönetimi konusunda da uzmanlar.', image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuA2EvdbSc2CjJQCQZh62GuBhps9Dau7ohXAEN33-NJ6MEzpaR7kG9b08g1G-GWKHYUt-JVfbUcH_stCZ3YiPqBf1h2BV4IQ-thBNY0KRqzHyK2sJId1UJFQtJ078pBzG2ticspzQrL8mffjjXfjOAPPK3t4WNuSMPHIAVvAFBAaBgthrXeoNTPI2RhC8s1DzyHNrVkoinRsIbeZHs838i_opxHBhWU7GA_EACJ4GafPghYYppPNkNOhZPGjBAdoncOcskt6Ghqwo1k4' },
    ...
    { name: 'Selin Arslan', role: 'Teknik Mimar, Yapı Merkezi', rating: 4.5, text: 'Teknolojik altyapıları ve modern mühendislik yaklaşımları onları rakiplerinden ayırıyor. Dijital ikiz projelerimizde sundukları vizyon çok etkileyiciydi.', image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuDh9tlecnyQ7Uh46YipA2KfqfNSBTMYUT9Aj9ji6ygeheyXwnC0Cb0Of6zIcwOlkfoOlqKRIBtd9Ym4KHrvG8Sm9k-vIPMCSOdCucUCnIDkbJO5Fo6bjmc3FedQA-O5O7nk8_7lcd7ZD0S0HLTweWkz2lD3hqr7ok1-vive9sTsToSeCQaE5qb4YlQPJlp67F3SM3Z1Thx59MwSm9I-4NXzXhNKbJVrTdGVU9ae2y1lu-zelPoIgRRMd4qomVLYEIaTsAS_4-vgjSAH' },
]
