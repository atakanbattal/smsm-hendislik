...
const standardsData = {
    adr: [
        ...
        { code: 'RID', name: 'Demiryolu', desc: 'Tehlikeli maddelerin demiryolu ile taşınması' },
        ...
        { code: 'EN 14432', name: 'Tank Vanaları', desc: 'Tank vana ve aksesuarları standardı' },
        { code: 'EN 13175', name: 'LPG Ekipman', desc: 'LPG tankları ekipman ve aksesuarları' },
        { code: 'EN 14595', name: 'Basınç Tahliye', desc: 'Tank basınç tahliye cihazları' },
        { code: 'EN 13317', name: 'Seviye Gösterge', desc: 'Tank seviye göstergeleri standardı' },
        { code: 'EN 13314', name: 'Hidrostatik Test', desc: 'Tank hidrostatik test gereksinimleri' },
    ],
    welding: [
        { code: 'ISO 3834-2', name: 'Kalite Kapsamlı', desc: 'Kaynak kalite yönetimi - Kapsamlı gereksinimler' },
        { code: 'ISO 3834-3', name: 'Kalite Standart', desc: 'Kaynak kalite yönetimi - Standart gereksinimler' },
        { code: 'EN 15085-2', name: 'Demiryolu CL1', desc: 'Demiryolu araçları CL1-CL4 sertifikasyonu' },
        { code: 'EN 1090-2', name: 'Çelik Yapılar', desc: 'Çelik yapıların imalat ve montajı' },
        { code: 'EN ISO 15614-1', name: 'WPQR Çelik', desc: 'Çelik kaynak prosedürü onay testi' },
        { code: 'EN ISO 15614-2', name: 'WPQR Alüminyum', desc: 'Alüminyum kaynak prosedürü onay testi' },
        { code: 'EN ISO 15609-1', name: 'WPS Ark', desc: 'Ark kaynağı prosedür şartnamesi' },
        { code: 'EN ISO 15609-2', name: 'WPS Gaz', desc: 'Gaz kaynağı prosedür şartnamesi' },
        { code: 'EN ISO 9606-1', name: 'Kaynakçı Çelik', desc: 'Çelik kaynakçı yeterlilik testi' },
        { code: 'EN ISO 9606-2', name: 'Kaynakçı Al', desc: 'Alüminyum kaynakçı yeterlilik testi' },
        { code: 'EN ISO 14732', name: 'Operatör', desc: 'Kaynak operatörü yeterlilik testi' },
        { code: 'EN ISO 14731', name: 'Koordinatör', desc: 'Kaynak koordinasyonu görevleri (RWC/IWE)' },
        { code: 'EN ISO 5817', name: 'Kalite Seviyesi', desc: 'Kaynak kusur kabul seviyeleri (B, C, D)' },
        { code: 'EN ISO 6520', name: 'Kusur Sınıflandırma', desc: 'Kaynak kusurlarının sınıflandırılması' },
        { code: 'EN ISO 2553', name: 'Semboller', desc: 'Kaynak sembollerinin çizimde gösterimi' },
        { code: 'EN ISO 13916', name: 'Ön Isıtma', desc: 'Kaynak ön ısıtma sıcaklığı ölçümü' },
    ],
    ndt: [
        ...
        { code: 'EN ISO 3452-1', name: 'PT - Penetrant', desc: 'Sıvı penetrant muayene genel prensipleri' },
        { code: 'EN ISO 17640', name: 'UT - Ultrasonik', desc: 'Kaynak bağlantılarının ultrasonik muayenesi' },
        { code: 'EN ISO 17636-1', name: 'RT - Film', desc: 'Kaynak dikişlerinin film radyografisi' },
        { code: 'EN ISO 17636-2', name: 'RT - Dijital', desc: 'Kaynak dikişlerinin dijital radyografisi' },
        { code: 'EN ISO 17637', name: 'VT - Görsel', desc: 'Kaynak dikişlerinin görsel muayenesi' },
        ...
        { code: 'EN ISO 13588', name: 'Phased Array', desc: 'Phased Array ultrasonik test (PAUT)' },
        { code: 'EN ISO 23277', name: 'PT Kabul', desc: 'Penetrant muayene kabul kriterleri' },
        { code: 'EN ISO 23278', name: 'MT Kabul', desc: 'Manyetik parçacık muayene kabul kriterleri' },
    ],
    dt: [
        { code: 'ISO 17025', name: 'DT Laboratuvar', desc: 'Tahribatlı muayene laboratuvarları akreditasyonu' },
        { code: 'EN ISO 6892-1', name: 'Çekme Oda', desc: 'Oda sıcaklığında çekme deneyi' },
        { code: 'EN ISO 6892-2', name: 'Çekme Yüksek', desc: 'Yüksek sıcaklıkta çekme deneyi' },
        { code: 'EN ISO 148-1', name: 'Charpy V', desc: 'Charpy V çentik darbe deneyi' },
        { code: 'EN ISO 6507-1', name: 'Vickers', desc: 'Vickers sertlik deneyi' },
        { code: 'EN ISO 6506-1', name: 'Brinell', desc: 'Brinell sertlik deneyi' },
        { code: 'EN ISO 6508-1', name: 'Rockwell', desc: 'Rockwell sertlik deneyi' },
        { code: 'EN ISO 5173', name: 'Eğme', desc: 'Kaynaklı birleştirmelerin eğme deneyi' },
        { code: 'EN ISO 17639', name: 'Makro/Mikro', desc: 'Kaynak makroskopik ve mikroskopik inceleme' },
        { code: 'EN ISO 9015-1', name: 'Sertlik HAZ', desc: 'Kaynak bölgesi sertlik haritalama' },
        { code: 'EN ISO 4136', name: 'Çapraz Çekme', desc: 'Alın kaynağı çapraz çekme deneyi' },
        { code: 'EN ISO 9017', name: 'Kırma', desc: 'Kaynak kırma (fraktür) deneyi' },
    ],
    regulation: [
        { code: '6331', name: 'İSG Kanunu', desc: 'İş Sağlığı ve Güvenliği Kanunu' },
        { code: '13094', name: 'Kontrol Tebliği', desc: 'İş Ekipmanları Periyodik Kontrol Tebliği' },
        { code: '25567', name: 'Yönetmelik', desc: 'İş Ekipmanlarının Kullanımında Sağlık ve Güvenlik Şartları' },
        { code: 'PED', name: '2014/68/EU', desc: 'Avrupa Basınçlı Ekipmanlar Direktifi' },
        { code: 'SEVESO', name: '2012/18/EU', desc: 'Büyük endüstriyel kazaların önlenmesi' },
        ...
        { code: 'EN 13480', name: 'Boru Hatları', desc: 'Metalik endüstriyel boru hatları' },
        { code: 'API 510', name: 'Basınçlı Kap', desc: 'Basınçlı kap muayene kodu' },
        { code: 'API 570', name: 'Boru Muayene', desc: 'Boru hattı muayene kodu' },
        { code: 'TÜRKAK', name: 'Akreditasyon', desc: 'Türk Akreditasyon Kurumu gereksinimleri' },
    ],
}
